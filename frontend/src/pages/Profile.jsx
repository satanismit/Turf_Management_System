    ...
    return (
      <div className="page-container flex-center">
        <div className="loading-container">
          ...
          <p className="space-top text-muted">Loading profile...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <Card>
              <div className="flex-between space-bottom-large">
              ...
              {message && (
                <div className={`space-bottom p-3 rounded ${message.includes('success') ? 'bg-green-100 border border-green-400 text-green-700' : 'bg-red-100 border border-red-400 text-red-700'}`}>
                  {message}
                </div>
              )}
